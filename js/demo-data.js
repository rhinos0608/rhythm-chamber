    ...
    const phases = [
        {
            ...
            focus: ['My Chemical Romance', 'Paramore', 'Fall Out Boy'],
            intensity: 'high',
        },
        {
            start: '2020-01',
            end: '2020-06',
            focus: ['Pierce The Veil', 'Sleeping With Sirens', 'Panic! At The Disco'],
            intensity: 'high',
        },
        {
            start: '2020-07',
            end: '2020-12',
            focus: ['Twenty One Pilots', 'Bring Me The Horizon', 'A Day To Remember'],
            intensity: 'medium',
        },
        {
            start: '2021-01',
            end: '2021-06',
            focus: ['The 1975', 'Arctic Monkeys', 'Neck Deep', 'Waterparks'],
            intensity: 'discovery',
        },
        {
            start: '2021-07',
            end: '2022-12',
            focus: ['My Chemical Romance', 'The 1975', 'Paramore', 'All Time Low'],
            intensity: 'medium',
        },
        {
            start: '2023-01',
            end: '2023-12',
            focus: ['Paramore', 'The 1975', 'Twenty One Pilots', 'Arctic Monkeys'],
            intensity: 'balanced',
        },
    ];
        ...
        while (currentDate <= phaseEnd) {
            ...
            for (let i = 0; i < streamsPerDay; i++) {
                ...
                streams.push({
                    ...
                    playType:
                        completionRate > 0.9 ? 'full' : completionRate < 0.5 ? 'skip' : 'partial',
...
const DEMO_PERSONALITY = {
    ...
    description:
        "You don't just listen to music — you use it to bookmark chapters of your life. Each era of your library tells a story, from your early MCR obsession to your current indie phase. When you hear certain songs, you're transported back to exactly who you were when you first loved them.",
    scores: {
        ...
        eras: [
            {
                ...
                topArtists: ['My Chemical Romance', 'Paramore', 'Fall Out Boy'],
                weeks: 52,
            },
            {
                start: '2020-01',
                end: '2020-12',
                topArtists: ['Pierce The Veil', 'Twenty One Pilots', 'Bring Me The Horizon'],
                weeks: 52,
            },
            {
                start: '2021-01',
                end: '2021-06',
                topArtists: ['The 1975', 'Arctic Monkeys', 'Neck Deep'],
                weeks: 26,
            },
            {
                start: '2021-07',
                end: '2022-12',
                topArtists: ['My Chemical Romance', 'The 1975', 'Paramore'],
                weeks: 78,
            },
            {
                start: '2023-01',
                end: '2023-12',
                topArtists: ['Paramore', 'The 1975', 'Twenty One Pilots'],
                weeks: 52,
            },
        ],
        hasEras: true,
