            ...
            parameters: {
                ...
                properties: {
                    query: {
                        type: 'string',
                        description:
                            "Natural language search query about patterns, moods, themes, emotions, or time periods in the user's listening history",
                    },
                    limit: {
                        type: 'integer',
