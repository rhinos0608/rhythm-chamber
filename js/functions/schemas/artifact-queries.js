...
const ARTIFACT_QUERY_SCHEMAS = [
    {
        ...
        function: {
            ...
            description:
                'Create a line chart showing how a listening metric changes over time. Use this when the user wants to SEE a trend, pattern, or change over time. Always explain what the chart shows.',
            parameters: {
                type: 'object',
                properties: {
                    metric: {
                    ...
                    annotations: {
                        ...
                        items: {
                            ...
                            properties: {
                                date: {
                                    type: 'string',
                                    description: 'Date for annotation (YYYY-MM)',
                                },
    ...
    },
    {
        ...
        function: {
            ...
            description:
                'Create a bar chart comparing metrics across categories (artists, time periods, genres). Use when the user wants to COMPARE things visually. Always explain the comparison.',
            parameters: {
                type: 'object',
                properties: {
                    comparison_type: {
                    ...
                    year: {
                        type: 'integer',
                        description:
                            'Year for the comparison (required for top_artists, top_tracks)',
                    },
                    periods: {
                        type: 'array',
                        items: {
    ...
    },
    {
        ...
        function: {
            ...
            description:
                'Create a timeline visualization showing key moments in listening history. Use for showing when artists were discovered, significant changes, or listening milestones.',
            parameters: {
                type: 'object',
                properties: {
                    timeline_type: {
    ...
    },
    {
        ...
        function: {
            ...
            description:
                "Create a calendar-style heatmap showing listening intensity over time. Use to show patterns like 'which days did I listen most' or 'show my listening activity'.",
            parameters: {
                type: 'object',
                properties: {
                    year: {
    ...
    },
    {
        ...
        function: {
            ...
            description:
                'Create a formatted data table for detailed information. Use when a list/table is clearer than a chart, like top tracks with play counts and artists.',
            parameters: {
                type: 'object',
                properties: {
                    table_type: {
