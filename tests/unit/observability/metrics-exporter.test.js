...
import {
  ...
  ScheduleType,
  ExternalService,
} from '../../../js/observability/metrics-exporter.js';
...
describe('MetricsExporter', () => {
  ...
  describe('External Service Integrations', () => {
    ...
    it('should format data for DataDog', () => {
      ...
      const formatted = exporter._formatForService(testData, ExternalService.DATADOG, {
        format: ExportFormat.JSON,
      });
    ...
    it('should format data for New Relic', () => {
      ...
      const formatted = exporter._formatForService(testData, ExternalService.NEWRELIC, {
        format: ExportFormat.JSON,
      });
