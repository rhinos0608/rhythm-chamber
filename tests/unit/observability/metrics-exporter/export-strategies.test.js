...
describe('ExportStrategies', () => {
  ...
  describe('pushExport', () => {
    ...
    test('should handle push errors', async () => {
      ...
      await expect(strategies.pushExport(endpoint, mockData)).rejects.toThrow('Network error');
    });
  ...
  describe('pullExport', () => {
    ...
    test('should handle pull errors', async () => {
      ...
      await expect(strategies.pullExport(endpoint)).rejects.toThrow('Network error');
    });
  ...
  describe('exportWithRetry', () => {
    ...
    test('should give up after max retries', async () => {
      ...
      await expect(
        strategies.exportWithRetry(() => strategies.pushExport(endpoint, mockData), {
          maxRetries: 2,
        })
  ...
  describe('handleResponse', () => {
    ...
    test('should handle failed response', async () => {
      ...
      await expect(strategies.handleResponse(response)).rejects.toThrow(
  ...
  describe('calculateRetryDelay', () => {
    ...
    test('should add jitter to prevent thundering herd', () => {
      const delays = Array.from({ length: 10 }, () => strategies.calculateRetryDelay(2, true, 0.1));
