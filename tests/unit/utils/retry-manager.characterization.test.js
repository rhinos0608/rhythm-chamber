    ...
    describe('Core Retry Functions', () => {
        describe('withRetry', () => {
            ...
            it('should stop retrying after maxRetries', async () => {
                ...
                await expect(RetryModule.withRetry(fn, { maxRetries: 2 }))
            ...
            it('should not retry non-retryable errors', async () => {
                ...
                await expect(RetryModule.withRetry(fn, { maxRetries: 3 }))
                    .rejects.toThrow('401');
            ...
            it('should respect abortSignal', async () => {
                ...
                await expect(RetryModule.withRetry(fn, { abortSignal: controller.signal }))
    ...
    describe('Advanced Patterns', () => {
        ...
        describe('withFallback', () => {
            ...
            it('should throw when all functions fail', async () => {
                ...
                await expect(RetryModule.withFallback([fn1, fn2]))
        ...
        describe('withStrategy', () => {
            ...
            it('should throw for unknown strategy', async () => {
                ...
                await expect(RetryModule.withStrategy(fn, 'UNKNOWN'))
                    .rejects.toThrow('Unknown retry strategy');
            });
        });
        ...
        describe('withCircuitBreaker', () => {
            ...
            it('should throw when circuit is open', async () => {
                ...
                await expect(RetryModule.withCircuitBreaker(checkCircuit, fn))
