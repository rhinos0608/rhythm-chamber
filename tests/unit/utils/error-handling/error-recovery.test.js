...
import { ErrorSeverity, ErrorRecoverability } from '../../../../js/utils/error-handling/error-classifier.js';
...
describe('error-recovery', () => {
    ...
    describe('attemptRecovery', () => {
        ...
        it('should sanitize retry error messages', async () => {
            const retryCallback = vi.fn().mockRejectedValue(
                new Error('API key sk-12345 failed')
            );
