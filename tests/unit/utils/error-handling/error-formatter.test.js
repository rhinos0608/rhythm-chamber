...
describe('error-formatter', () => {
    ...
    describe('formatForToast', () => {
        ...
        it('should truncate long messages for unknown errors', () => {
            const error = {
                type: 'UNKNOWN_ERROR',
                message: 'This is a very long error message that should be truncated to fit in a toast notification without taking up too much space on the screen'
            };
            const result = formatForToast(error);
