...
describe('Checkpoint Storage Strategy', () => {
  ...
  describe('Threshold Detection', () => {
    ...
    it('should classify large texts as requiring IndexedDB', () => {
      ...
      const largeTexts = Array(30000).fill(
        'This is a reasonably sized text chunk for embedding that contains some content'
      );
...
describe('Large Data Handling', () => {
  ...
  it('should identify when IndexedDB is needed', () => {
    ...
    const largeData = Array(20000).fill(
      'This is a reasonably sized text chunk for semantic search embedding that contains multiple words and phrases'
    );
