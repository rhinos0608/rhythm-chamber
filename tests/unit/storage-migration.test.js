...
describe('Storage Migration Paths', () => {
    ...
    it('should detect need for migration when old data exists', async () => {
        // Add old-format data
        localStorage.setItem('rhythm_chamber_personality', JSON.stringify({ type: 'emotional_archaeologist' }));
    ...
    it('should handle partial migration gracefully', async () => {
        ...
        localStorage.setItem('rhythm_chamber_personality', JSON.stringify({ type: 'discovery_junkie' }));
...
describe('Storage Migration Edge Cases', () => {
    it('should handle IndexedDB write failures', async () => {
        ...
        localStorage.setItem('rhythm_chamber_personality', JSON.stringify({ type: 'social_chameleon' }));
