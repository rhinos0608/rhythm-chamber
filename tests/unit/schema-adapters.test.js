...
describe('UniversalSchema toOpenAI', () => {
    it('should convert simple schema to OpenAI format', () => {
        ...
        expect(result.function.parameters.properties.time_range.enum).toEqual(['all_time', 'last_year', 'last_month']);
...
describe('UniversalSchema Utilities', () => {
    ...
    it('should throw for unknown provider', () => {
        expect(() => UniversalSchema.convertSchemas([testSchema], 'unknown'))
            .toThrow(/Unknown provider/);
    });

    it('should create schema from simplified definition', () => {
        const schema = UniversalSchema.createSchema(
            'test_function',
            'A test function',
            {
