...
const mockStreams = [
  ...
  },
  {
    ...
    master_metadata_track_name: 'Song D',
    master_metadata_album_artist_name: 'Artist 3',
    ms_played: 220000,
  },
  {
    ts: '2024-01-15T23:30:00Z',
    master_metadata_track_name: 'Song E',
    master_metadata_album_artist_name: 'Artist 1',
    ms_played: 180000,
  },
];
...
const mockProfile1 = {
  personality: {
    ...
    traits: { nostalgia: 80, discovery: 40 },
  },
...
const mockProfile2 = {
  personality: {
    type: 'genre_tourist',
    name: 'Genre Tourist',
    traits: { nostalgia: 30, discovery: 90 },
  },
...
describe('PatternComparison', () => {
  ...
  it('should compare patterns correctly', () => {
    const result = PatternComparison.comparePatterns(mockProfile1.patterns, mockProfile2.patterns);
  ...
  it('should throw when profiles are missing', () => {
    expect(() => PatternComparison.compareProfiles(null, mockProfile2)).toThrow(
      'Both profiles required'
    );
  });
});
...
describe('PlaylistGenerator', () => {
  ...
  it('should throw when era dates are missing', () => {
    expect(() => PlaylistGenerator.createPlaylistFromEra(mockStreams, {})).toThrow(
