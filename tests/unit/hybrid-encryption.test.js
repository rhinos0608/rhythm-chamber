...
describe('HybridEncryption Module', () => {
    ...
    describe('exportPublicKey', () => {
        ...
        it('should throw for non-public key', async () => {
            ...
            await expect(
                HybridEncryption.exportPublicKey(keyPair.privateKey)
            ).rejects.toThrow('Key must be a public key');
        });
    });
    ...
    describe('encrypt/decrypt', () => {
        ...
        it('should throw for invalid plaintext type', async () => {
            ...
            await expect(
                HybridEncryption.encrypt(12345, keyPair.publicKey)
            ).rejects.toThrow('Plaintext must be a string');
        });
        ...
        it('should throw for non-public key', async () => {
            ...
            await expect(
                HybridEncryption.encrypt('data', keyPair.privateKey)
            ).rejects.toThrow('Recipient key must be a public key');
        });
    ...
    describe('encryptForMultiple/decryptMultiple', () => {
        ...
        it('should throw when no recipients provided', async () => {
            ...
            await expect(
                HybridEncryption.encryptForMultiple('data', {})
    ...
    describe('exportPrivateKey/importPrivateKey', () => {
        ...
        it('should throw for non-private key on export', async () => {
            ...
            await expect(
                HybridEncryption.exportPrivateKey(keyPair.publicKey)
            ).rejects.toThrow('Key must be a private key');
        });
    });
});
