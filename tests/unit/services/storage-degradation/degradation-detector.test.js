...
describe('DegradationDetector', () => {
  ...
  describe('_determineDegradationTier', () => {
    ...
    it('should return WARNING for 80-94% usage', () => {
      expect(detector._determineDegradationTier({ usagePercent: 80 })).toBe(
        DegradationTier.WARNING
      );
      expect(detector._determineDegradationTier({ usagePercent: 85 })).toBe(
        DegradationTier.WARNING
      );
      expect(detector._determineDegradationTier({ usagePercent: 94 })).toBe(
        DegradationTier.WARNING
      );
    });

    it('should return CRITICAL for 95-98% usage', () => {
      expect(detector._determineDegradationTier({ usagePercent: 95 })).toBe(
        DegradationTier.CRITICAL
      );
      expect(detector._determineDegradationTier({ usagePercent: 97 })).toBe(
        DegradationTier.CRITICAL
      );
      expect(detector._determineDegradationTier({ usagePercent: 98 })).toBe(
        DegradationTier.CRITICAL
      );
    });

    it('should return EMERGENCY for 99% usage', () => {
      expect(detector._determineDegradationTier({ usagePercent: 99 })).toBe(
        DegradationTier.EMERGENCY
      );
    });

    it('should return EXCEEDED for 100%+ usage', () => {
      expect(detector._determineDegradationTier({ usagePercent: 100 })).toBe(
        DegradationTier.EXCEEDED
      );
      expect(detector._determineDegradationTier({ usagePercent: 105 })).toBe(
        DegradationTier.EXCEEDED
      );
    });
