...
describe('TierHandlers', () => {
  ...
  describe('Performance Marking', () => {
    it('should mark tier transition start', async () => {
      ...
      expect(markSpy).toHaveBeenCalledWith(expect.stringContaining('storage-tier-transition'));
    });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle handler errors gracefully', async () => {
      ...
      await expect(
        handlers._transitionToTier(DegradationTier.WARNING, DegradationTier.NORMAL)
