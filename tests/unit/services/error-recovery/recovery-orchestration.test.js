...
import { RecoveryDomain, RecoveryPriority, RecoveryState } from '../../../../js/services/error-recovery-coordinator.js';
...
describe('RecoveryOrchestration', () => {
    ...
    beforeEach(() => {
        ...
        mockStrategies = {
            ...
            getDependencyHandlerName: vi.fn((dep) => dep === 'operation_lock' ? 'acquireRecoveryLock' : null)
        };

        mockLockManager = {
            acquireRecoveryLock: vi.fn(function() { return 'lock-id-123'; }),
    ...
    describe('Recovery Execution', () => {
        it('should execute recovery plan successfully', async () => {
            ...
            mockStrategies.getHandlers.mockReturnValue(new Map([
                [RecoveryDomain.SECURITY, [mockHandler]]
            ]));
        ...
        it('should execute all recovery steps', async () => {
            ...
            mockStrategies.getHandlers.mockReturnValue(new Map([
                [RecoveryDomain.SECURITY, [mockHandler1, mockHandler2]]
            ]));
        ...
        it('should handle step failures gracefully', async () => {
            ...
            mockStrategies.getHandlers.mockReturnValue(new Map([
                [RecoveryDomain.SECURITY, [mockHandler1, mockHandler2, mockHandler3]]
            ]));
    ...
    describe('Recovery Coordination', () => {
        ...
        it('should track active recoveries', async () => {
            const mockHandler = vi.fn().mockImplementation(() => new Promise(resolve => setTimeout(resolve, 100)));
            mockStrategies.getHandlers.mockReturnValue(new Map([
                [RecoveryDomain.SECURITY, [mockHandler]]
            ]));
    ...
    describe('Cancellation', () => {
        it('should cancel active recovery', async () => {
            ...
            expect(mockEventBus.emit).toHaveBeenCalledWith('RECOVERY:CANCELLED', { recoveryId: 'recovery-123' });
        });
