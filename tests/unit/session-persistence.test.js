...
describe('SessionPersistence - saveConversation', () => {
    ...
    it('should debounce save calls', async () => {
        const { saveConversation, getAutoSaveTimeoutId, clearAutoSaveTimeout } = await import('../../js/services/session-manager/session-persistence.js');
...
describe('SessionPersistence - saveCurrentSession', () => {
    ...
    it('should save session to IndexedDB', async () => {
        const { saveCurrentSession } = await import('../../js/services/session-manager/session-persistence.js');
    ...
    it('should generate title from first user message', async () => {
        ...
        vi.mocked(SessionState.getSessionData).mockReturnValue({
            ...
            messages: [
                ...
                { role: 'user', content: 'This is a long message that should be truncated to fifty characters' },
...
describe('SessionPersistence - emergencyBackupSync', () => {
    ...
    it('should save backup to localStorage synchronously', () => {
        ...
        return import('../../js/services/session-manager/session-persistence.js').then(({ emergencyBackupSync }) => {
            emergencyBackupSync();
...
describe('SessionPersistence - recoverEmergencyBackup', () => {
    ...
    it('should return false when no backup exists', async () => {
        const { recoverEmergencyBackup } = await import('../../js/services/session-manager/session-persistence.js');
...
describe('SessionPersistence - flushPendingSaveAsync', () => {
    ...
    it('should flush pending save and clear timeout', async () => {
        const { saveConversation, flushPendingSaveAsync, getAutoSaveTimeoutId } = await import('../../js/services/session-manager/session-persistence.js');
    ...
    it('should clear emergency backup after successful save', async () => {
        const { flushPendingSaveAsync } = await import('../../js/services/session-manager/session-persistence.js');
        ...
        vi.mocked(SessionState.getCurrentSessionCreatedAt).mockReturnValue('2024-01-01T00:00:00.000Z');
        mockStorage.saveSession.mockResolvedValue(true);
        localStorageMock.store['rc_session_emergency_backup'] = JSON.stringify({ sessionId: 'test-id' });
