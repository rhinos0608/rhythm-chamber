...
describe('Error Handling Security Tests', () => {
    ...
    describe('1. Sensitive Data Redaction in normalizeError()', () => {
        ...
        it('should redact bearer tokens', () => {
            ...
            expect(classified.originalError.message).not.toContain('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9');
        ...
        it('should redact URL parameters with sensitive data', () => {
            const errorMessage = 'Request failed: https://api.example.com?api_key=secret12345&token=abcxyz';
            const error = new Error(errorMessage);
            const classified = ErrorHandler.classify(error);
    ...
    describe('6. Integration Tests', () => {
        ...
        it('should handle real-world error scenarios', () => {
            ...
            expect(anthropicClassified.originalError.message).not.toContain('sk-ant-api03-1234567890abcdef');
            ...
            expect(networkClassified.originalError.message).not.toContain('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9');
