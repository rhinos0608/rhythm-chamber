...
describe('Fallback Response Generator', () => {
  ...
  beforeEach(async () => {
    ...
    const module =
      await import('/Users/rhinesharar/rhythm-chamber/js/services/fallback/fallback-response.js');
  ...
  describe('Query Context Generation', () => {
    it('should generate query context from last message', async () => {
      ...
      const { FallbackResponseService } =
        await import('/Users/rhinesharar/rhythm-chamber/js/services/fallback-response-service.js');
