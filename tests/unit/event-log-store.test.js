...
describe('EventLogStore', () => {
  ...
  describe('Event Storage', () => {
    ...
    it('should store high-resolution timestamp', async () => {
      ...
      const event = await EventLogStore.appendEvent('test_event', {}, vectorClock, 'tab_1');
  ...
  describe('Checkpointing', () => {
    it('should create checkpoint', async () => {
      const checkpoint = await EventLogStore.createCheckpoint(5, { test: 'metadata' });
  ...
  describe('Edge Cases', () => {
    it('should handle concurrent event appends', async () => {
      ...
      const promises = [];
      for (let i = 0; i < 10; i++) {
        promises.push(EventLogStore.appendEvent(`event${i}`, { index: i }, vectorClock, 'tab_1'));
      }
