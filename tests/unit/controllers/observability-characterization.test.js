...
describe('ObservabilityController - Characterization Tests', () => {
  ...
  describe('Cleanup and Destruction', () => {
    ...
    it('should remove event listeners on destroy', () => {
      ...
      expect(removeEventListenerSpy).toHaveBeenCalledWith('observability:show', onShowDashboard);
      expect(removeEventListenerSpy).toHaveBeenCalledWith('observability:hide', onHideDashboard);
